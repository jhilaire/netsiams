...
cur_case = "2°C"
lines(
  data_plot$period[which(data_plot$tempcat == cur_case & data_plot$variable == "Emissions|CO2")],
  data_plot$med[which(data_plot$tempcat == cur_case & data_plot$variable == "Emissions|CO2")],
  col=u_col_case1, lwd=2
)
points(
  data_plot$period[which(data_plot$tempcat == cur_case & data_plot$variable == "Emissions|CO2")],
...
color = u_col_case1
cur_case = "2°C"
lines(c(pos, pos), c(data_plot$min[which(data_plot$tempcat == cur_case)], data_plot$max[which(data_plot$tempcat == cur_case)]), col=color)
rect(
  pos-offset, data_plot$p15[which(data_plot$tempcat == cur_case)], 
  pos+offset, data_plot$p85[which(data_plot$tempcat == cur_case)], 
  col=color, border=NA
)
lines(c(pos-offset, pos+offset), c(data_plot$med[which(data_plot$tempcat == cur_case)], data_plot$med[which(data_plot$tempcat == cur_case)]), col="#ffffff")
points(c(pos, pos), c(data_plot$mean[which(data_plot$tempcat == cur_case)], data_plot$mean[which(data_plot$tempcat == cur_case)]), pch=21, col=color, bg="#ffffff")
...
# )
# lines(c(pos-offset, pos+offset), c(data_plot$med[which(data_plot$tempcat == cur_case)], data_plot$med[which(data_plot$tempcat == cur_case)]), col="#ffffff")
# #lines(c(pos-offset, pos+offset), c(data_plot$med[which(data_plot$tempcat == cur_case)], data_plot$med[which(data_plot$tempcat == cur_case)]), col="#0000ff")
# points(c(pos, pos), c(data_plot$mean[which(data_plot$tempcat == cur_case)], data_plot$mean[which(data_plot$tempcat == cur_case)]), pch=21, col=color, bg="#ffffff")
# 
# axis(2)
# 
...
rect(
  pos-offset, 0.0,
  pos+offset, data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Land Use|Cumulative")],
  col="#008000ff", border=NA)
# Gross FFI
rect(
  pos-offset, data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Land Use|Cumulative")],
  pos+offset, data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Land Use|Cumulative")] +
    data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Fossil Fuels and Industry|Gross|Cumulative")],
  col="#424242ff", border=NA)
# Negative part
# Gross BECCS
rect(
  pos-offset, 0.0,
  pos+offset, data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Carbon Capture and Storage|Biomass|Cumulative")],
  col="#a02c2cff", border=NA)
# 
rect(
  pos-offset2, data_plot$p15[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")],
  pos+offset2, data_plot$p85[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")],
  col="#2270d43c", border=NA
)
lines(
  c(pos-offset2, pos+offset2),
  c(
    data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")],
    data_plot$med[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")]
  ),
  col="#000000"
)
points(
  c(pos, pos),
  c(
    data_plot$mean[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")],
    data_plot$mean[which(data_plot$tempcat == cur_case & data_plot$period == "2011-2100" & data_plot$variable == "Emissions|CO2|Cumulative")]
  ),
